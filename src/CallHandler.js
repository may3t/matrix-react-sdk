...
async function _startCallApp(roomId, type) {
    ...
    if (currentJitsiWidgets.length > 0) {
        ...
        Modal.createTrackedDialog('Already have Huddle Widget', '', ErrorDialog, {
            title: _t('Call in Progress'),
    ...
    const confId = `Tambuli${generateHumanReadableId()}`;
    ...
    WidgetUtils.setRoomWidget(roomId, widgetId, WidgetType.JITSI, widgetUrl, 'Tambuli Huddle', widgetData).then(() => {
