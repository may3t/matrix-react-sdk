...
export class Jitsi {
    ...
    public get preferredDomain(): string {
        return this.domain || 'meet.tambulihuddle.com';
    ...
    private update = async (discoveryResponse): Promise<any> => {
        ...
        let domain = (SdkConfig.get()['jitsi'] || {})['preferredDomain'] || 'meet.tambulihuddle.com';
        ...
        this.domain = domain;
        console.log("Tambuli Huddle conference domain:", this.preferredDomain);
    };
